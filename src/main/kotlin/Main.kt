...
fun main() {
    ...
    do {
        ...
        println("2) Cadastrar usuário organizador ")
        println("3) Alterar perfil do usuário ")
        println("4) Visualizar perfil do usuário ")
        println("5) Inativar usuário ")
        println("6) Reativar usuário ")

        println("7) Cadastrar evento ")
        println("8) Alterar evento ")
        println("9) Ativar evento ")
        println("10) Desativar evento ")

        println("11) Listar eventos do organizador ")
        println("12) Feed de eventos ")
        println("13) Comprar ingresso ")
        println("14) Cancelar ingresso ")
        println("15) Listar ingressos do usuário ")
